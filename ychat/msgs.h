...
#define SEPERAT "----------------------------------------- "
#define s_sockCRT "Creating server socket "
#define s_sockERR "Could not create socket. Trying next port "
#define s_sockRDY "Server socket is ready. See port above "
